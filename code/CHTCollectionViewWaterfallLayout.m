...
- (void)commonInit {
  ...
  _itemRenderDirection = CHTCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight;
}
...
- (CGSize)collectionViewContentSize {
  ...
  contentSize.height = [[[self.columnHeights lastObject] firstObject] floatValue] + 100;
